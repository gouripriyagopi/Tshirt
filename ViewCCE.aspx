<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ViewCCE.aspx.cs" Inherits="Admin_ViewCCE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <tr>
            ...
            <td class="auto-style4">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="Larger" ForeColor="#006600" Text="Approved Customer Care Executives"></asp:Label>
            </td>
 ...
 <br />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TShirtDBConnectionString %>" SelectCommand="SELECT * FROM [Registration] WHERE (([Status] = @Status) AND ([Usertype] = @Usertype))">
                    <SelectParameters>
                        ...
                        <asp:Parameter DefaultValue="Customer Care Executive" Name="Usertype" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
            ...
            <td>
                <asp:DataList ID="DataList2" runat="server" DataKeyField="Email" DataSourceID="SqlDataSource2" Height="2680px" Width="310px" OnItemCommand="DataList2_ItemCommand">
                    <ItemTemplate>
                        ...
                        <br />
                        <br />
                        &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton ID="LinkButton3" runat="server" CommandArgument='<%# Eval("Email") %>' CommandName="Reject" Font-Bold="True" ForeColor="Red">Remove Executive</asp:LinkButton>
                        &nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <br />
                    </ItemTemplate>
                </asp:DataList>
