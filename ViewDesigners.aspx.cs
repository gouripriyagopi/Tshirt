...
public partial class Admin_ViewDesigners : System.Web.UI.Page
{
    ...
    protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        if (e.CommandName.ToString() == "Approve")
        {
            ...
            Response.Redirect("ViewDesigners.aspx");
        }
    ...
    protected void DataList2_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToString() == "ViewBio")
        {
            Session["CurrentUser"] = e.CommandArgument.ToString();
            Response.Redirect("ViewBio.aspx");
        }
    }
