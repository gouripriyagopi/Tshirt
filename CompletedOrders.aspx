<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/MasterPage.master" AutoEventWireup="true" CodeFile="CompletedOrders.aspx.cs" Inherits="Customer_CompletedOrders" %>
            ...
            <td>
                <asp:DataList ID="DataList1" runat="server" CellPadding="4" DataKeyField="order_id" DataSourceID="SqlDataSource1" ForeColor="#333333" OnItemCommand="DataList1_ItemCommand">
                    ...
                    <ItemTemplate>
                        ...
                        <br />
                        <br />
                        &nbsp;Replacement can be initiated within 7 days from delivery&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <br />
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                        <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("order_id") %>' CommandName="Replace">Replace Order</asp:LinkButton>
                        <br />
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <br />
