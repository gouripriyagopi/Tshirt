<%@ Page Title="" Language="C#" MasterPageFile="~/Designer/MasterPage.master" AutoEventWireup="true" CodeFile="ProductDetails.aspx.cs" Inherits="Designer_ProductDetails" %>
                    ...
                    <asp:ListItem></asp:ListItem>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <br />
                                    <br />
										<label class="col-md-2 control-label">Delivery Within (Days)</label>
										<div class="col-md-8">
											<div class="input-group input-icon right">
												<span class="input-group-addon">
													<i class="fa fa-envelope-o"></i>
                                                ...
                                                <asp:TextBox ID="Delivery" runat="server" class="form-control1" TextMode="Number" ></asp:TextBox>		
                                                <br />
                                            </div>
										</div>
										<div class="col-sm-2">
                                            <asp:requiredfieldvalidator ID="Requiredfieldvalidator3" runat="server" errormessage="Enter Delivery Period" ControlToValidate="Delivery" ForeColor="Red"></asp:requiredfieldvalidator>
										</div>
									</div>
