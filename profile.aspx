<%@ Page Title="" Language="C#" MasterPageFile="~/Customer Care Executive/MasterPage.master" AutoEventWireup="true" CodeFile="profile.aspx.cs" Inherits="Customer_Care_Executive_profile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="nav-justified">
        ...
        <tr>
            <td class="auto-style1">&nbsp;</td>
            <td>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TShirtDBConnectionString %>"  SelectCommand="SELECT * FROM [State]"></asp:SqlDataSource>
