...
public partial class Guest_Registration_CustomerCareExecutive : System.Web.UI.Page
{
    connection con = new connection();
    protected void Page_Load(object sender, EventArgs e)
    {
        Label2.Text = "Customer Care Executive";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            con.dr.Close();
            string Usertype = "Customer Care Executive";
